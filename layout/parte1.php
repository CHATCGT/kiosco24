                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item ">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo $URL;?>/almacen/modificar_precios.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item ">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo $URL;?>/compras/reporte_compras.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Generar Reporte</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item ">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo $URL;?>/ventas/reporte_ventas.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Generar Reporte</p>
                                </a>
                            </li>
