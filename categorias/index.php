                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" id="nombre_categoria<?php echo $id_categoria;?>" value="<?php echo $nombre_categoria; ?>" class="form-control" pattern="[A-Za-z ]+" title="Solo se permiten letras y espacios">
                                                                                <small style="color: red;display: none" id="lbl_update<?php echo $id_categoria;?>">* Este campo es requerido</small>
                                                                                <small style="color: red;display: none" id="lbl_update_invalid<?php echo $id_categoria;?>">* Solo se permiten letras y espacios</small>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <script>
                                                        $('#btn_update<?php echo $id_categoria;?>').click(function () {
                                                            ...
                                                            if(!regex.test(nombre_categoria)){
                                                                $('#lbl_update_invalid<?php echo $id_categoria;?>').css('display','block');
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre_categoria" class="form-control" pattern="[A-Za-z ]+" title="Solo se permiten letras y espacios">
                            <small style="color: red;display: none" id="lbl_create">* Este campo es requerido</small>
                            <small style="color: red;display: none" id="lbl_create_invalid">* Solo se permiten letras y espacios</small>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $('#btn_create').click(function () {
        ...
        var regex = /^[A-Za-z ]+$/;
        if(!regex.test(nombre_categoria)){
            $('#lbl_create_invalid').css('display','block');
        } else if(nombre_categoria == ""){
